...
The NSF [grant](https://www.nsf.gov/awardsearch/showAward?AWD_ID=1955049) that supported the bootcamp engaged an external evaluator to survey participants.
Here are the main findings:

![](include/img/post-survey-fig1.png)

![](include/img/post-survey-fig2.png)

![](include/img/post-survey-fig3.png)

![](include/img/post-survey-fig4.png)

![](include/img/post-survey-fig5.png)
